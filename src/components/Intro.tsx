        ...
        <Container>
          <Grid container>
            <Grid item xs={12} sm={6}>
              <Box mt={15} mb={15} width="100%" onClick={() => toggle(!open)} onMouseEnter={() => toggle(!open)}>
                <animated.svg width="100%" viewBox="0 0 1278 446">
                  <defs>
                    <filter id="water">
            ...
            <Grid item container xs={12} sm={6}>
              <Box m="auto">
                <Typography>
                  'hello' is a onClick, onHover animated SVG. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut
